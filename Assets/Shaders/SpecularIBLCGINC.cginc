            ...
            float4 frag(Interpolators i) : SV_Target
            {
                    ...
                    //DIFFUSE IBL
                        ...
                        float3 specularIBL = tex2Dlod(_SpecularIBL, float4(DirToRectillinear(viewRefl),0,0)).xyz;
                        //diffuseLight += specularIBL;
                        diffuseLight += _AmbientLight;
                        specularLight += specularIBL * _SpecIBLIntensity * fresnel; // adding to specular instead of diffuse makes the object a lot more reflective & shiny
                    #endif
